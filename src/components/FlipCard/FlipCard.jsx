...
function FlipCard({front,back}) {
  ...
  return (
    <div className='flex justify-center items-center bg-black rounded-2xl text-white cursor-pointer '>
        <div className='flip-card md:w-[600px] md:h-[360px] w-[400px] h-[500px] rounded-lg ' onClick={handleFlip}>
            <motion.div
